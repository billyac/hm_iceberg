...
def dispatch(train_files, learning_rate):
    # Original Data
    train = pd.read_json(train_files)
    ...
    folds = list(
        StratifiedKFold(n_splits=2, shuffle=True, random_state=16).split(
    ...
    for j, (train_idx, valid_idx) in enumerate(folds):
        ...
        score = model.evaluate(
            [X_valid_cv, X_inc_valid], y_valid_cv, verbose=0)
...
#     folds = list(
#         StratifiedKFold(n_splits=K, shuffle=True, random_state=16).split(
#             X_train, target_train))
#     y_test_pred_log = 0
#     y_train_pred_log = 0
...
#         print(
#             "Submission: {}, Model Name: InceptionResNetV2 with Angle,4 fold, 0 level locked, no drop".
#             format(name_str),
#             file=text_file)
#         print(
#             "Steps per epoch: {}, LR: {}, Decay: {}".format(
#                 steps, learning_rate, decay),
#             file=text_file)
#         print(
#             "Train Log Loss: {}".format(
#                 log_loss(target_train, y_train_pred_log)),
#             file=text_file)
#         print(
#             "Validation Log Loss: {}".format(
#                 log_loss(target_train, y_valid_pred_log)),
#             file=text_file)
#         print(
#             "Leader Board: _______________________________________",
#             file=text_file)
